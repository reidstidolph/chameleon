...
module.exports = function(passport) {
    ...
    passport.deserializeUser(function(id, done) {
        chameleonDataModel.User.findById(id, function(err, user) {
            done(err, user);
        });
    });
    ...
    function(req, username, password, done) {
        ...
        chameleonDataModel.User.findOne({ 'username' :  username }, function(err, user) {
            ...
            if (user) {
                ...
                // create the user
                var newUser = new chameleonDataModel.User();
