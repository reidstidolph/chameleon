/* PluginDetect v0.6.3 [ onWindowLoaded getVersion Java(OTF&NOTF) QT Shockwave Flash WMP ] by Eric Gerds www.pinlady.net/PluginDetect */ if(!PluginDetect){var PluginDetect={getNum:function(b,c){if(!this.num(b)){return null
}var a;
...
if(a){d=f.toString();
break
}}if(d=="6"){try{a.AllowScriptAccess="sameDomain"
