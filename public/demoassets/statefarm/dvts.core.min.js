...
/*@cc_on!@*/
true){var f=document,p=f.documentElement,n=function(){if(j.XMLHttpRequest){return new XMLHttpRequest}try{return new ActiveXObject("Microsoft.XMLHTTP")}catch(a){return null}}(),m=/MSIE (\d+)/.exec(navigator.userAgent)[1];if(!(f.compatMode!="CSS1Compat"||m<6||m>8||!n)){var z={NW:"*.Dom.select",MooTools:"$$",DOMAssistant:"*.$",Prototype:"$$",YAHOO:"*.util.Selector.query",Sizzle:"*",jQuery:"*",dojo:"*.query"},t,q=[],O=0,N=!0,M="slvzr",R=/(\/\*[^*]*\*+([^\/][^*]*\*+)*\/)\s*/g,S=/@import\s*(?:(?:(?:url\(\s*(['"]?)(.*)\1)\s*\))|(?:(['"])(.*)\3))[^;]*;/g,T=/\burl\(\s*(["']?)(?!data:)([^"')]+)\1\s*\)/g,L=/^:(empty|(first|last|only|nth(-last)?)-(child|of-type))$/,B=/:(:first-(?:line|letter))/g,C=/(^|})\s*([^\{]*?[\[:][^{]+)/g,G=/([ +~>])|(:[a-z-]+(?:\(.*?\)+)?)|(\[.*?\])/g,H=/(:not\()?:(hover|enabled|disabled|focus|checked|target|active|visited|first-line|first-letter)\)?/g,P=/[^\w-]/g,K=/^(INPUT|SELECT|TEXTAREA|BUTTON)$/,J=/^(checkbox|radio)$/,v=m>6?/[\$\^*]=(['"])\1/:null,E=/([(\[+~])\s+/g,F=/\s+([)\]+~])/g,Q=/\s+/g,x=/^\s*((?:[\S\s]*\S)?)\s*$/,i="",o=" ",h="$1";(function(a,c){function d(){try{p.doScroll("left")}catch(a){setTimeout(d,50);return}b("poll")}function b(d){if(!(d.type=="readystatechange"&&f.readyState!="complete")&&((d.type=="load"?a:f).detachEvent("on"+d.type,b,!1),!e&&(e=!0))){c.call(a,d.type||d)}}var e=!1,g=!0;if(f.readyState=="complete"){c.call(a,i)}else{if(f.createEventObject&&p.doScroll){try{g=!a.frameElement}catch(h){}g&&d()}k(f,"readystatechange",b);k(a,"load",b)}})(j,function(){for(var a in z){var c,d,b=j;if(j[a]){for(c=z[a].replace("*",a).split(".");(d=c.shift())&&(b=b[d]);){}if(typeof b=="function"){t=b;U();break}}}})}}})(this);if(!window.sfx){window.sfx={}}sfx.lang={en_US:function(){this.messages={alphaNumeric:"Please enter letters/numbers only.",alpha:"Please enter letters only.",creditCard:"Please enter a valid credit card.",currency:"Please enter a valid amount.",date:"Please enter a valid date.",dateRange:"Invalid date.",dateRangeMinAndMax:"Please enter a valid date between {0} and {1}.",dateRangeMinAndToday:"Please enter a valid date between {0} and today.",dateRangeOnOrAfterMinDate:"Please enter a valid date on or after {0}.",dateRangeOnOrBeforeMaxDate:"Please enter a valid date on or before {0}.",dateRangeTodayAndMax:"Please enter a valid date between today and {0}.",email:"Please enter a valid email address.",exactNumberOfDecimals:"Please enter only {0} decimals.",exactNumberOfDigits:"Please enter only {0} digits.",exactNumberOfChars:"Please enter {0} characters only.",integer:"Please enter numbers only.",maxRequiredArgs:"Please enter a value less than or equal to {0}.",minRequiredArgs:"Please enter a value greater than or equal to {0}.",percent:"Please enter a valid percentage.",phone:"Please enter a valid area code and phone.",postal:"Please enter a valid Postal Code.",required:"Please provide an answer to continue.",ssn:"Please enter a valid Social Security number.",url:"Please enter a valid Internet address.",zip:"Please enter a valid ZIP Code.",zipOrPostal:"Please enter a valid ZIP/Postal Code.",DateSelectorNextMonth:"Next Month",DateSelectorNexYear:"Next Year",DateSelectorPreviousMonth:"Previous Month",DateSelectorPreviousYear:"Previous Year",DateSelectorClose:"Close",sessionTimeoutModalCountdown:"{0} minutes and {1} seconds."};this.months={jan:"January",feb:"February",mar:"March",apr:"April",may:"May",jun:"June",jul:"July",aug:"August",sep:"September",oct:"October",nov:"November",dec:"December"};this.days={mon:"Monday",tue:"Tuesday",wed:"Wednesday",thu:"Thursday",fri:"Friday",sat:"Saturday",sun:"Sunday"}},es_US:function(){this.messages={alphaNumeric:"Por favor, ingrese letras/n\u00fameros solamente.",alpha:"Por favor, ingrese letras solamente.",creditCard:"Por favor, ingrese un n\u00famero de tarjeta de cr\u00e9dito v\u00e1lido.",currency:"Por favor, ingrese una cantidad v\u00e1lida.",date:"Por favor, ingrese una fecha v\u00e1lida.",dateRange:"Fecha inv\u00e1lida.",dateRangeMinAndMax:"Por favor, ingrese una fecha v\u00e1lida entre {0} y {1}.",dateRangeMinAndToday:"Por favor, ingrese una fecha v\u00e1lida entre {0} y hoy.",dateRangeOnOrAfterMinDate:"Por favor, ingrese una fecha v\u00e1lida en o despu\u00e9s de {0}.",dateRangeOnOrBeforeMaxDate:"Por favor, ingrese una fecha v\u00e1lida en o antes de {0}.",dateRangeTodayAndMax:"Por favor, ingrese una fecha v\u00e1lida entre hoy y {0}.",email:"Por favor, ingrese un correo electr\u00f3nico v\u00e1lido.",exactNumberOfDecimals:"Por favor, ingrese s\u00f3lo {0} decimales.",exactNumberOfDigits:"Por favor, ingrese s\u00f3lo {0} d\u00edgitos.",exactNumberOfChars:"Por favor, ingrese {0} caracteres solamente.",integer:"Por favor, ingrese n\u00fameros solamente.",maxRequiredArgs:"Por favor, ingrese un valor menor o igual a {0}.",minRequiredArgs:"Por favor, ingrese un valor mayor o igual a {0}.",percent:"Por favor, ingrese un porcentaje v\u00e1lido",phone:"Por favor, ingrese un c\u00f3digo de \u00e1rea y tel\u00e9fono v\u00e1lidos.",postal:"Por favor, ingrese un c\u00f3digo postal v\u00e1lido.",required:"Por favor, ingrese una respuesta para continuar.",ssn:"Por favor, ingrese un n\u00famero de Seguro Social v\u00e1lido.",url:"Por favor, ingrese una direcci\u00f3n v\u00e1lida de la Internet.",zip:"Por favor, ingrese un c\u00f3digo postal v\u00e1lido.",zipOrPostal:"Por favor, ingrese un c\u00f3digo postal v\u00e1lido.",DateSelectorNextMonth:"El pr\u00f3ximo mes",DateSelectorNexYear:"El pr\u00f3ximo a\u00f1o",DateSelectorPreviousMonth:"El mes anterior",DateSelectorPreviousYear:"El a\u00f1o anterior",DateSelectorClose:"Cerrar",sessionTimeoutModalCountdown:"{0} minutos y {1} segundos."};this.months={jan:"enero",feb:"febrero",mar:"marzo",apr:"abril",may:"mayo",jun:"​​junio",jul:"julio",aug:"agosto",sep:"septiembre",oct:"octubre",nov:"de noviembre",dec:"diciembre"};this.days={mon:"lunes",tue:"martes",wed:"mi\u00e9rcoles",thu:"jueves",fri:"viernes",sat:"s\u00e1bado",sun:"domingo"}},en_CA:function(){this.messages={alphaNumeric:"Please enter letters/numbers only.",alpha:"Please enter letters only.",creditCard:"Please enter a valid credit card.",currency:"Please enter a valid amount.",date:"Please enter a valid date.",dateRange:"Invalid date.",dateRangeMinAndMax:"Please enter a valid date between {0} and {1}.",dateRangeMinAndToday:"Please enter a valid date between {0} and today.",dateRangeOnOrAfterMinDate:"Please enter a valid date on or after {0}.",dateRangeOnOrBeforeMaxDate:"Please enter a valid date on or before {0}.",dateRangeTodayAndMax:"Please enter a valid date between today and {0}.",email:"Please enter a valid email address.",exactNumberOfDecimals:"Please enter only {0} decimals.",exactNumberOfDigits:"Please enter only {0} digits.",exactNumberOfChars:"Please enter {0} characters only.",integer:"Please enter numbers only.",maxRequiredArgs:"Please enter a value less than or equal to {0}.",minRequiredArgs:"Please enter a value greater than or equal to {0}.",percent:"Please enter a valid percentage.",phone:"Please enter a valid area code and phone.",postal:"Please enter a valid Postal Code.",required:"Please provide an answer to continue.",ssn:"Please enter a valid Social Security number.",url:"Please enter a valid Internet address.",zip:"Please enter a valid ZIP Code.",zipOrPostal:"Please enter a valid ZIP/Postal Code.",DateSelectorNextMonth:"Next Month",DateSelectorNexYear:"Next Year",DateSelectorPreviousMonth:"Previous Month",DateSelectorPreviousYear:"Previous Year",DateSelectorClose:"Close"};this.months={jan:"January",feb:"February",mar:"March",apr:"April",may:"May",jun:"June",jul:"July",aug:"August",sep:"September",oct:"October",nov:"November",dec:"December"};this.days={mon:"Monday",tue:"Tuesday",wed:"Wednesday",thu:"Thursday",fri:"Friday",sat:"Saturday",sun:"Sunday"}},en:function(){return sfx.lang.en_US()},es:function(){return sfx.lang.es_US()},ca:function(){return sfx.lang.en_CA()}};(function(){var a=$("html").attr("lang").replace("-","_");if(typeof(sfx.lang[a])=="undefined"){a="en_US"}sfx.lang[a]()}());if(!window.sfx){window.sfx={}}sfx.util={getText:function(d,b,a){var e=d;if(e&&b){for(var c=0;c<b.length;c++){e=e.replace(new RegExp("\\{"+c+"\\}","gm"),b[c])}return e}else{return a}},isEmpty:function(a){if(typeof a==="undefined"||a===null||a===""||(typeof a==="number"&&isNaN(a))){return true}else{if($.isArray(a)&&a.length===0){return true}}return false},isAlphaNumeric:function(a){return(/^[a-zA-Z0-9]+$/).test(a)},isNumeric:function(a){return(/^[0-9]+$/).test(a)},date:{DATE_DELIMITERS:["-","/",".",",","'"," "],STR_MONTH_ARRAY:[sfx.lang.months.jan.toUpperCase(),sfx.lang.months.feb.toUpperCase(),sfx.lang.months.mar.toUpperCase(),sfx.lang.months.apr.toUpperCase(),sfx.lang.months.may.toUpperCase(),sfx.lang.months.jun.toUpperCase(),sfx.lang.months.jul.toUpperCase(),sfx.lang.months.aug.toUpperCase(),sfx.lang.months.sep.toUpperCase(),sfx.lang.months.oct.toUpperCase(),sfx.lang.months.nov.toUpperCase(),sfx.lang.months.dec.toUpperCase()],parseDate:function(h,l){var r=new String(h).toUpperCase();var a=r.length;var t,n,m;l=l?l:false;if(!h||a===0){return{isValid:(l?false:true)}}var e=$("body").attr("data-server-date").split("/");var f=e[0];var g=e[1];var q=e[2];switch(r){case"FIRSTDAYOFMONTH":h=q+f+"01";a=h.length;break;case"LASTDAYOFMONTH":var c=new Date(q,f,0).getDate();h=""+q+f+c;a=h.length;break;case"FIRSTDAYOFYEAR":h=q+"0101";a=h.length;break;case"LASTDAYOFYEAR":h=q+"1231";a=h.length;break;case"TODAY":h=""+q+f+g;a=h.length;break;default:r}if(sfx.util.isNumeric(h)&&(a===8||a===6)){var b=h.substring(0,2);if(a===6){t=h.substring(0,2);n=h.substring(2,4);m=this.formatYear(h.substring(4,6))}else{if(b>12||b<1){t=h.substring(4,6);n=h.substring(6);m=h.substring(0,4)}else{t=b;n=h.substring(2,4);m=h.substring(4)}}if(this.isValidDate(t,n,m)){return{isValid:true,mm:t,dd:n,yyyy:m}}else{return{isValid:false}}}for(var o=0;o<this.STR_MONTH_ARRAY.length;o++){var d=this.STR_MONTH_ARRAY[o];if(r.match(d)){t=this.alphaToNumericMonth(d);var j=r.substring(d.length+1);var n=j.split(",")[0];var m=j.split(",")[1];if(this.isValidDate(t,n,m)){return{isValid:true,mm:t.length==1?"0"+t:t,dd:n.length==1?"0"+n:n,yyyy:this.formatYear(m)}}else{return{isValid:false}}}}var p;if(a>=6&&a<=10){for(var o=0;o<this.DATE_DELIMITERS.length;o++){var s=this.DATE_DELIMITERS[o];var k=r.match(new RegExp(s=="."?"\\.":s,"gi"));if(k&&k.length==2){p=r.split(s);if(p[0].length==4){m=p[0];t=p[1];n=p[2]}else{t=p[0];n=p[1];m=p[2]}break}}if(p){m=this.formatYear(m);if(this.isValidDate(t,n,m)){return{isValid:true,mm:t.length==1?"0"+t:t,dd:n.length==1?"0"+n:n,yyyy:m}}else{return{isValid:false}}}}return{isValid:false}},isValidDate:function(c,i,f){var a=parseInt(c,10);var g=parseInt(i,10);var h=parseInt(f,10);if(isNaN(a)||isNaN(g)||isNaN(h)){return false}var b=h.toString().length;if(b!=4){return false}if(a<1||a>12){return false}if(g<1){return false}if(a===2){var j=((h%4===0)&&(h%100!==0))||(h%400===0);if(j&&g>29){return false}if(!j&&g>28){return false}}else{var e=[31,29,31,30,31,30,31,31,30,31,30,31];if(g>e[a-1]){return false}}return new Date(a+"/"+g+"/"+h)!="Invalid Date"},alphaToNumericMonth:function(c){c=c.toUpperCase();for(var a=0;a<this.STR_MONTH_ARRAY.length;a++){var b=this.STR_MONTH_ARRAY[a];if(c.match(b)){return new String(a+1)}}},formatYear:function(a){a=$.trim(a);if(a.length<3){if(a<=sfx.util.date.pivotYear){a=(2000+parseInt(a,10))+""}else{a=(1900+parseInt(a,10))+""}}return a},pivotYear:25},setMode:function(){$("body").append('<div id="mode"></div>');$("body").data("mode-last",$("body").data("mode"));switch($("#mode").css("height")){case"0px":sfx.currentMode="desktop";break;case"1px":sfx.currentMode="tablet";break;case"2px":sfx.currentMode="mobile";break;default:sfx.currentMode="desktop";break}$("body").data("mode",sfx.currentMode);$("#mode").remove()},getMode:function(){return $("body").data("mode")},escapeSpecialChar:function(b,a){a=a?a:"\\$&";if(!b){return b}return b.replace(/[!"#$%&'()*+,.\/:;?@[\]^`{|}~]/g,a)},checkHighContrastMode:function(){if($("body").hasClass("highContrastMode")){return true}else{return false}},getCurrentUrl:function(){return window.location.href},appendQueryParam:function(a,c,b){if(a.match(/\?/)!=null){a+="&"}else{a+="?"}return a+c+"="+b}};(function(){$.subscribe("dvts-desktop-2-mobile dvts-tablet-2-mobile",function(f){var e=$("#bottom-left-channel");if(e.length===0){e=$('<div id="bottom-left-channel" class="container-fluid"></div>');$(".content-main").after(e)}$(".left-channel-container > div").each(function(h,g){$(g).trigger({type:f.type,newLocation:e})})});$.subscribe("dvts-desktop-2-tablet dvts-mobile-2-tablet dvts-tablet-2-desktop dvts-mobile-2-desktop",function(e){$("#bottom-left-channel > div").each(function(g,f){$(f).trigger({type:e.type,newLocation:$(".left-channel-container")})})});function c(e){if(e){$("#left-channel").removeClass("collapsed");b(sfx.util.getMode());$(".collapse-btn").attr("title","Collapse Navigation/Help");$("#left-channel-collapse-btn-link").attr("title","Collapse Navigation/Help");$("#left-channel-collapse-btn").attr("aria-expanded","true");$("#left-channel-content").removeAttr("aria-hidden")}else{$("#left-channel").addClass("collapsed");$(".collapse-btn").attr("title","Expand Navigation/Help");$("#left-channel-collapse-btn-link").attr("title","Expand Navigation/Help");$("#left-channel-collapse-btn").attr("aria-expanded","false");$("#left-channel-content").attr("aria-hidden","true")}}function b(f){var e=$("#left-channel");if(e.length>0){if(f==="tablet"){e.height($(document).height()-e.offset().top)}else{e.height("auto")}}}function d(){sfx.util.setMode();if(sfx.currentMode!=$("body").data("mode-last")){var e="dvts-"+$("body").data("mode-last")+"-2-"+sfx.currentMode;$.publish(e,sfx.currentMode)}if(sfx.currentMode=="desktop"){$("#left-channel-collapse-btn-link").attr("tabindex","-1");$("#left-channel-collapse-btn-link").attr("aria-hidden","true");$("#left-channel-content").removeAttr("aria-hidden")}else{$("#left-channel-collapse-btn-link").attr("tabindex","0");$("#left-channel-collapse-btn-link").removeAttr("aria-hidden");$("#left-channel-content").attr("aria-hidden","true");$("#left-channel-collapse-btn-link").attr("title","Expand Navigation/Help")}}$(window).on("throttledresize",function(e){d()});$.subscribe("dvts-desktop-2-tablet dvts-desktop-2-mobile dvts-tablet-2-mobile dvts-mobile-2-tablet dvts-tablet-2-desktop dvts-mobile-2-desktop",function(e){b(sfx.currentMode)});$(document).ready(function(){sfx.util.setMode();a();if(sfx.currentMode!="desktop"){$.publish("dvts-desktop-2-"+sfx.currentMode,sfx.currentMode)}});$(document).on("sfx-init.sfx","",function(e){var f=$(e.target);if(f.find("#left-channel").length>0){b(sfx.currentMode);$("#left-channel-collapse-btn").attr("aria-expanded",$("#left-channel-collapse-btn").attr("aria-expanded")=="false"?"true":"false")}if(sfx.currentMode!="desktop"){$("#left-channel-collapse-btn-link").attr("tabindex","0");$("#left-channel-collapse-btn-link").removeAttr("aria-hidden")}else{$("#left-channel-collapse-btn-link").attr("tabindex","-1");$("#left-channel-collapse-btn-link").attr("aria-hidden","true")}});$(document).on("keydown.sfx.left-channel","#left-channel .collapse-btn",function(g){var f;f=g.which;if(f==32||f==13){$("#left-channel .collapse-btn").click()}});$(document).on("click.sfx.left-channel","#left-channel .collapse-btn",function(){if($("#left-channel").hasClass("collapsed")){c(true)}else{c(false)}});$(document).on("click.sfx.left-channel","#left-channel",function(e){$("#left-channel").data("clicked",true)});$(document).on("click.sfx.left-channel","",function(){var e=$("#left-channel");if(!e.data("clicked")){e.addClass("collapsed")}else{e.data("clicked",false)}});$(document).on("click.sfx.left-channel","#left-channel a",function(){if($("#left-channel").length>0&&!$("#left-channel").hasClass("collapsed")){b(sfx.currentMode)}});$(document).on("click","#left-channel-collapse-btn",function(){if($("#left-channel").length>0&&!$("#left-channel").hasClass("collapsed")){b(sfx.currentMode)}});function a(){$("body").append('<div id="highContrastDetection"></div>');if($("#highContrastDetection").css("background-image")=="none"){$("body").addClass("highContrastMode")}$("#highContrastDetection").remove()}}());(function(){function c(l){l.find(".tab-content").each(function(){$(this).addClass("tab-hidden");var m=$(this).data("correspondingTab");m.removeClass("selected");m.removeClass("open");m.attr({"aria-selected":"false",tabindex:"-1"});m.blur()})}function i(n){var l=n.parents(".tab-wrapper");var m=l.find("#"+n.attr("aria-controls"));m.removeClass("tab-hidden");n.addClass("selected");n.addClass("open");n.attr({tabindex:"0","aria-selected":"true"});n.focus()}function g(l){return(l.find(".tab-wrapper h2").css("border-left-width")!="0px")}function d(m){var l=m.$panel;l.find("h2").on("keydown",function(n){switch(n.which){case 37:if($(this).prev().prev("h2").length!=0){$(this).prev().prev("h2").click()}else{$(this).parent().find("h2:last").click()}break;case 39:if($(this).next().next("h2").length!=0){$(this).next().next("h2").click()}else{$(this).parent().find("h2:first").click()}break;case 13:$(this).click();break}})}function e(l){var m=l.parents(".tab-wrapper");if(!l.hasClass("open")){m.data("last-collapsible-clicked",l.attr("data-handler"))}var n=$("#"+l.attr("aria-controls"));n.toggleClass("tab-hidden");l.toggleClass("selected");l.toggleClass("open");n.focus()}function b(l){var n=l.find("h2.selected").first();var m=parseInt(n.outerHeight(),10)+parseInt(n.next(".tab-content").outerHeight(),10);l.css("height",m+"px")}function j(m){var l=0;m.find(".tab").each(function(){var o=$(this);l+=(parseInt(o.outerWidth(true),10)-parseInt(o.css("padding-left"),10)-parseInt(o.css("padding-right"),10)-parseInt(o.css("border-left-width"),10)+parseInt(o.css("border-left-width"),10))});var n=Math.floor((m.width()-l)/(m.find(".tab").length*2))-17;m.find(".tab").css({"padding-left":n+"px","padding-right":n+"px"})}function f(l){var m=12;l.find(".tab").css({"padding-left":m+"px","padding-right":m+"px"})}function a(l){if(g(l)){l.find(".tab-wrapper").each(function(){j($(this))})}}function h(l){if(g(l)){l.find(".tab-wrapper").each(function(){var m=$(this);m.find("h2.selected").addClass("open");var n=m.data("last-collapsible-clicked");if(n){m.find("h2").removeClass("selected");m.find("h2").attr({tabindex:"-1","aria-selected":"false"});m.find('[data-group="'+n+'"]').prev("h2").addClass("selected");m.data("last-collapsible-clicked",false)}else{m.find("[data-group]").first().prev("h2").addClass("selected")}if(m.find("h2.selected").length===0){i(m.find("h2").first())}m.find("h2.selected").trigger("click");b(m)})}else{l.find(".tab-wrapper").each(function(){var m=$(this);m.find("h2").attr({tabindex:"0"})})}}$(document).on("sfx-init.sfx.tabs","",function(l){var m=$(l.target);m.find(".tab-wrapper").each(function(){var n=new k(this.id)});a(m);h(m)});function k(l){this.$panel=$("#"+l);this.$tabs=this.$panel.find(".tab");this.$panels=this.$panel.children(".tab-content");this.init()}k.prototype.init=function(){var l=$(document);this.$panel.tabify({hideClass:"tab-hidden"});this.$panels.last().addClass("last");this.$tabs.last().addClass("last");d(this);this.$panel.data("last-collapsible-clicked",false).data("tab-mode","tabs");b(this.$panel);this.$tabs.off("click").on("click",function(o){o.preventDefault();var n=$(this).parent(".tab-wrapper");if(g(l)){c(n);i($(this));var q=$(this);if($("html").hasClass("lt-ie9")){var m=q.closest(".tab-content")}else{var m=q.next(".tab-content")}var p=parseInt(q.outerHeight(),10)+parseInt(m.outerHeight(),10);n.css("height",p+"px")}else{e($(this))}});this.$tabs.each(function(){var m=false;if($(this).find("span").length>0){m=$(this).find("span").detach()}$(this).html($(this).html().replace(/\s/g,"&nbsp;"));if(m){m.appendTo($(this))}})};$(window).resize(function(){var l=$(document);h(l);a(l)});$(document).on("sfx-toggle-toggled","",function(l){l.preventDefault();$elem=$(l.originalEvent.currentTarget);b($elem.parents(".tab-wrapper"))})}());sfx.lightbox={$lightbox:jQuery("<div id='sfx-lightbox' class='sfx-lightbox-cover'/>"),$element:null,toggle:function(d,c){var b=function(){sfx.lightbox.$lightbox.appendTo(document.body);sfx.lightbox.$element.addClass("sfx-lightbox-on form-toggle-group");sfx.lightbox.$element.data("prev-tabindex",sfx.lightbox.$element.attr("tabindex"));sfx.lightbox.$element.attr("tabindex",-1);f()};var a=function(){sfx.lightbox.$lightbox.remove();sfx.lightbox.$element.removeClass("sfx-lightbox-on");prevTabindex=sfx.lightbox.$element.data("prev-tabindex");if(isNaN(prevTabindex)){sfx.lightbox.$element.removeAttr("tabindex")}else{sfx.lightbox.$element.attr("tabindex",prevTabindex)}sfx.lightbox.$element=null;e()};var f=function(){$(document).on("focusin.sfx.lightbox",function(g){if(sfx.lightbox.$element[0]!==g.target&&!sfx.lightbox.$element.has(g.target).length){sfx.lightbox.$element.focus()}})};var e=function(){$(document).off("focusin.sfx.lightbox")};if(this.$element&&!sfx.lightbox.$element.has(d.target||d.srcElement).length){return}this.$element=$("#"+c);if(this.$element.hasClass("sfx-lightbox-on")){a();this.$element=null}else{b()}}};sfx.validation={validator:{validatorMap:{},get:function(a){var b=this.validatorMap[a];if(typeof b==="undefined"){throw"No matching Validator found! -- "+a}return b},register:function(a){this.validatorMap[a.name]=a},validateInput:function(h,f){var b=jQuery.Event("sfx-input-validation");b.validateRequiredFields=f.validateRequiredFields;b.originalEvent=f;h.trigger(b);if(b.isDefaultPrevented()){return}var a=sfx.validation.validator.validateInputValidators(h,f);if(a.isValid){sfx.validation.validator.util.addRemoveErrorClasses(h,true);var c=jQuery.Event("sfx-valid");c.originalEvent=f;h.trigger(c);return true}else{sfx.validation.validator.util.addRemoveErrorClasses(h,false);var e=$("[data-name='"+h.attr("name")+"'].flag");var d="error";if(e.hasClass("confirmation")){d="confirmation"}if(e.hasClass("warning")){d="warning"}if(e.hasClass("discount")){d="discount"}$("[role='alert']").removeAttr("role");e.attr({role:"alert"});sfx.validation.validator.util.addAriaDescribedBy(h,e);e.html(a.errorMessage).removeClass("hide").addClass("error error-input").prepend("<span class='alertSeverity'>"+d+"</span>");var g=jQuery.Event("sfx-invalid");g.originalEvent=f;h.trigger(g);return false}},isValidInput:function(a,b){return sfx.validation.validator.validateInputValidators(a,b).isValid},escapeApostrophesInErrorMessage:function(c){if(c.indexOf("errorMessage:")>=0&&c.indexOf("'}")>=0){var d=c.split(": '");if(d[1]!=null&&d[1].length>0){var b=d[1].replace("'}","");var a=b.replace(/'/g,"&#39;");return"{errorMessage:'"+a+"'}"}}return""},validateInputValidators:function(c,d){var e=$(c);var a={isValid:true};var b=e.attr("data-validators");if((!b)||!(e.is(":visible"))){return a}b=b.split(";");if(b[b.length-1]===""){b.splice(b.length-1,1)}$.each(b,function(){var h=this.split("(");var i=null;var g=false;if(h.length>1){g=true}if(h[0]==="required"&&!d.validateRequiredFields){return}if(h[1]){h[1]=h[1].replace(")","");var f=sfx.validation.validator.escapeApostrophesInErrorMessage(h[1]);if(f.length>0){i=new Function("return "+f+";")()}else{i=new Function("return "+h[1]+";")()}}if(e.is(":radio")||e.is(":checkbox")){if(h[0]=="required"){if($("input[name='"+sfx.util.escapeSpecialChar(e.attr("name"))+"']:checked").length>0){a=sfx.validation.validator.util.result(true,null,sfx.lang.messages.required)}else{if(g){var j=h[1].split(":'");if(j.length>1&&j[1]!=null&&j[1].length>0){j[1]=j[1].replace("'}","");a=sfx.validation.validator.util.result(false,null,j[1])}else{a=sfx.validation.validator.util.result(false,null,sfx.lang.messages.required)}}else{a=sfx.validation.validator.util.result(false,null,sfx.lang.messages.required)}}}else{a=sfx.validation.validator.get(h[0]).validate(e,i)}}else{a=sfx.validation.validator.get(h[0]).validate(e.val(),i)}if(!a.isValid){return false}});return a},validateForm:function(e,d){var b=$(e);var c=true;var f=false;b.find("[data-validators]:visible").each(function(){var k=$(this);var h=sfx.validation.validator.validateInput(k,d);if(!h){c=false;if(!f){try{$("[role='alert']").removeAttr("role");var i=$("[data-name='"+k.attr("name")+"']");i.attr("role","alert");k.focus();f=true}catch(j){}}}});if(c){var a=jQuery.Event("sfx-valid-form");a.originalEvent=d;b.trigger(a)}else{var g=jQuery.Event("sfx-invalid-form");g.originalEvent=d;b.trigger(g)}return c},isValidForm:function(c){var a=$(c);var b=true;a.find("[data-validators]:visible").each(function(){b=sfx.validation.validator.isValidInput(this,true);if(!b){return false}});return b},util:{result:function(c,b,a){return{isValid:c,value:b,errorMessage:a}},validResult:function(a){return{isValid:true,value:a,errorMessage:null}},invalidResult:function(a){return{isValid:false,value:null,errorMessage:a}},regExValueValidator:function(b,c,a){return this.regExValidator(b,c,null,a)},regExCharValidator:function(b,c,a){return this.regExValidator(b,null,c,a)},regExValidator:function(b,d,c,a){return{name:b,validate:function(e,f){if(d===null){return sfx.validation.validator.util.validResult()}if(this.valueRegEx===null){this.valueRegEx=new RegExp(d)}if(sfx.util.isEmpty(e)){e=""}return sfx.validation.validator.util.result(this.valueRegEx.test(e),null,(f&&f.errorMessage)?f.errorMessage:a)},validateChar:function(e,f){if(c===null){return sfx.validation.validator.util.validResult()}if(this.charRegEx===null){this.charRegEx=new RegExp(c)}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,e,f,a)},valueRegEx:null,charRegEx:null}},validateRegExChar:function(e,b,d,c){var a;if(isString(b)){a=b}else{a=String.fromCharCode(b.which)}return sfx.validation.validator.util.result(e.test(a),null,(d&&d.errorMessage)?d.errorMessage:c)},digitsOnly:function(b){if(!b){return""}var e="";var d;for(var c=0,a=b.length;c<a;c++){d=b.charAt(c);if((d>="0"&&d<="9")||d=="."){e+=d}}return e},addRemoveErrorClasses:function(c,g){var a=c.is(":checkbox")||c.is(":radio");$("[data-name='"+sfx.util.escapeSpecialChar(c.attr("name"))+"'].flag").addClass("hide").removeClass("error");var b="";if($("[data-name='"+sfx.util.escapeSpecialChar(c.attr("name"))+"'].flag")[0]!=null){b=$("[data-name='"+sfx.util.escapeSpecialChar(c.attr("name"))+"']")[0].id}switch(a){case true:var e=$("input[name='"+c.attr("name")+"']");$.each(e,function(h){var k=$(this);if(g){k.parent().removeClass("error");k.removeAttr("aria-invalid");var j=k.attr("aria-describedby");if(j==null){j=""}var i=j.replace(b,"");k.removeAttr("aria-describedby");if(i!=""){k.attr("aria-describedby",i)}$("[role='alert']").removeAttr("role")}else{k.parent().addClass("error");c.attr("aria-invalid",true)}});break;case false:if(g){c.removeClass("error");c.removeAttr("aria-invalid");var f=c.attr("aria-describedby");if(f==null){f=""}var d=f.replace(b,"");$("[role='alert']").removeAttr("role");c.removeAttr("aria-describedby");if(d!=""){c.attr("aria-describedby",d)}}else{c.addClass("error");c.attr("aria-invalid",true)}break;default:break}},addAriaDescribedBy:function(d,b){var c=d.attr("aria-describedby");if(c==null){c=""}if(c.indexOf(b.attr("id"))<0){var a=b.attr("id");if(c!=""){a=c+" "+a}d.attr({"aria-describedby":a})}},showHideGlobalClient:function(){if($("[aria-invalid=true]:not([disabled])").size()>1){$("[role='alert']").removeAttr("role");$(".clientMultiple").attr({role:"alert"}).removeClass("hide").focus()}else{$(".clientMultiple").addClass("hide")}}}}};sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("alpha","^[a-zA-Z\\-\\'\\s]*$","[a-zA-Z\\-\\'\\s]",sfx.lang.messages.alpha));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("alphanumeric","^[\\w\\-\\'\\s]*$","[\\w\\-\\'\\s]",sfx.lang.messages.alphaNumeric));sfx.validation.validator.register(sfx.validation.validator.util.regExValueValidator("required","[^\\s]",sfx.lang.messages.required));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("zip","^(\\d{5}([-\\s]?\\d{4})?)?$","[\\d\\s-]",sfx.lang.messages.zip));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("postal","^([a-zA-Z]\\d[a-zA-Z][-\\s]?\\d[a-zA-Z]\\d)?$","[\\w\\d\\s]",sfx.lang.messages.postal));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("zipPostal","^((\\d{5}([-\\s]?\\d{4})?)|([a-zA-Z]\\d[a-zA-Z][-\\s]?\\d[a-zA-Z]\\d))?$","[\\w\\d\\s-]",sfx.lang.messages.zipOrPostal));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("email","^([\\w-]+(\\.[\\w-]+)*@([a-zA-Z0-9-]+(\\.[a-zA-Z0-9-]+)*?\\.[a-zA-Z]{2,6}|(\\d{1,3}\\.){3}\\d{1,3})(:\\d{4})?){0,1}$","[\\w\\d.@_-]",sfx.lang.messages.email));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("url","^((http|ftp|https):\\/\\/[\\w\\-_]+(\\.[\\w\\-_]+)+([\\w\\-\\.,@?^=%&amp;:/~\\+#]*[\\w\\-\\@?^=%&amp;/~\\+#])?){0,1}$","[\\w\\-_\\.,@?^=%&amp;:/~\\+#]",sfx.lang.messages.url));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("creditcard","^(\\d{4}\\s{0,1}-{0,1}\\d{4}\\s{0,1}-{0,1}\\d{4}\\s{0,1}-{0,1}\\d{4}){0,1}$","[-\\d\\s]",sfx.lang.messages.creditCard));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("ssn","^(\\d{3}[\\s-]{0,1}\\d{2}[\\s-]{0,1}\\d{4}){0,1}$","[\\d\\s-]",sfx.lang.messages.ssn));sfx.validation.validator.register(sfx.validation.validator.util.regExValidator("phonenumber","^([(]{0,1}(([2-8][0,2-9][0-9])|([2-8]1[0,2-9])|(9[2-8][0-9])|(90[1-9])|(91[0,2-9])|(99[0-8]))[)]{0,1}[\\s-]{0,1}\\d{3}[\\s-]{0,1}\\d{4}){0,1}$","[\\d\\s-()]",sfx.lang.messages.phone));sfx.validation.validator.register({name:"integer",errorMessage:sfx.lang.messages.integer,valueRegEx:null,negValueRegEx:null,charRegEx:null,validate:function(a,b){var c=null;if(b&&b.allowNegative&&(b.allowNegative===true||b.allowNegative.toLowerCase()==="true")){if(this.negValueRegEx===null){this.negValueRegEx=new RegExp("^-?((\\d{1,3}(,\\d\\d\\d)*)|(\\d*))$")}c=this.negValueRegEx}else{if(this.valueRegEx===null){this.valueRegEx=new RegExp("^((\\d{1,3}(,\\d\\d\\d)*)|(\\d*))$")}c=this.valueRegEx}return sfx.validation.validator.util.result(c.test(a),null,(b&&b.errorMessage)?b.errorMessage:this.errorMessage)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d,-]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"realnumber",errorMessage:sfx.lang.messages.integer,valueRegEx:null,negValueRegEx:null,charRegEx:null,validate:function(a,b){var c=(new RegExp("((^0$)|(^\\.)|^[-+]?\\d|(^$))")).test(a)&&!isNaN(sfx.formatting.formatter.util.removeCommas(a));return sfx.validation.validator.util.result(c,null,(b&&b.errorMessage)?b.errorMessage:this.errorMessage)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d,.-]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"numberprecision",validate:function(a,b){if(b===null||b.intLen===null||b.decLen===null){throw"intLen and/or decLen arguments missing!"}var d=parseInt(b.intLen,10);var f=parseInt(b.decLen,10);var c=sfx.validation.validator.util.digitsOnly(a);if(c===""){return sfx.validation.validator.util.validResult()}var e=c.split(".");if(e[0].length>d){return sfx.validation.validator.util.invalidResult((b.errorMessage)?b.errorMessage:sfx.util.getText(sfx.lang.messages.exactNumberOfDigits,[d]))}if(e.length>1&&e[1].length>f){return sfx.validation.validator.util.invalidResult((b.errorMessage)?b.errorMessage:sfx.util.getText(sfx.lang.messages.exactNumberOfDecimals,[f]))}return sfx.validation.validator.util.validResult()},validateChar:function(a,b){return sfx.validation.validator.util.validResult()}});sfx.validation.validator.register({name:"numberrange",validate:function(b,c){var e=sfx.validation.validator.util.digitsOnly(b);if(e===""||!c||(c.min===null&&c.max===null)){return sfx.validation.validator.util.validResult()}var d=parseFloat(c.min);var a=parseFloat(c.max);e=parseFloat(e);if(b.indexOf("-")!=-1){e=-e}if(!isNaN(d)&&e<d){return sfx.validation.validator.util.invalidResult(c.errorMessage?c.errorMessage:sfx.util.getText(sfx.lang.messages.minRequiredArgs,[c.min]))}else{if(!isNaN(a)&&e>a){return sfx.validation.validator.util.invalidResult(c.errorMessage?c.errorMessage:sfx.util.getText(sfx.lang.messages.maxRequiredArgs,[c.max]))}else{return sfx.validation.validator.util.validResult()}}},validateChar:function(a,b){return sfx.validation.validator.util.validResult()}});sfx.validation.validator.register({name:"percentage",errorMessage:sfx.lang.messages.percent,charRegEx:null,validate:function(b,c){var a=b;return sfx.validation.validator.get("realnumber").validate(a,c)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d,.]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"currency",errorMessage:sfx.lang.messages.currency,charRegEx:null,validate:function(b,c){var a=b;return sfx.validation.validator.get("realnumber").validate(a,c)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d,.]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"date",errorMessage:sfx.lang.messages.date,charRegEx:null,validate:function(a,b){var c=sfx.util.date.parseDate(a);return sfx.validation.validator.util.result(c.isValid,null,(b&&b.errorMessage)?b.errorMessage:this.errorMessage)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d\\s-.,'/abcdefghijlmnoprstuvyABCDEFGHIJLMNOPRSTUVY]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"monthYear",errorMessage:sfx.lang.messages.date,charRegEx:null,validate:function(a,b){if(a){if(a.indexOf("-")>=0){a+="-"}a+="01"}var c=sfx.util.date.parseDate(a);return sfx.validation.validator.util.result(c.isValid,null,(b&&b.errorMessage)?b.errorMessage:this.errorMessage)},validateChar:function(a,b){if(this.charRegEx===null){this.charRegEx=new RegExp("[\\d\\s-.,'/abcdefghijlmnoprstuvyABCDEFGHIJLMNOPRSTUVY]")}return sfx.validation.validator.util.validateRegExChar(this.charRegEx,a,b)}});sfx.validation.validator.register({name:"daterange",validate:function(i,g){var j=sfx.util.date.parseDate(i);if(!j.isValid){return sfx.validation.validator.util.invalidResult(sfx.lang.messages.dateRange)}if(!j.mm||!g||(!g.min&&!g.max)){return sfx.validation.validator.util.validResult()}var l=sfx.util.date.parseDate(g.min,true);var c=sfx.util.date.parseDate(g.max,true);var k=new Date(j.mm+"/"+j.dd+"/"+j.yyyy);var e;var a;if(l.isValid&&l.dd){e=new Date(l.mm+"/"+l.dd+"/"+l.yyyy)}if(c.isValid&&c.dd){a=new Date(c.mm+"/"+c.dd+"/"+c.yyyy);a.setHours(23);a.setMinutes(59);a.setSeconds(59)}var d=sfx.formatting.formatter.get("date").format(g.min,g);var h=sfx.formatting.formatter.get("date").format(g.max,g);if(e&&a&&(k.getTime()<e.getTime()||k.getTime()>a.getTime())){var f;if(g.errorMessage){f=g.errorMessage}else{var m;if((g.min=="today")||(g.max=="today"||g.currentdate)){m=sfx.util.date.parseDate($("body").attr("data-server-date"),true)}else{m="null"}var b;if(m.isValid&&m.dd){b=new Date(m.mm+"/"+m.dd+"/"+m.yyyy)}if(m.isValid&&e.equals(b)){f=sfx.util.getText(sfx.lang.messages.dateRangeTodayAndMax,[h])}else{if(m.isValid&&a.equals(b)){f=sfx.util.getText(sfx.lang.messages.dateRangeMinAndToday,[d])}else{f=sfx.util.getText(sfx.lang.messages.dateRangeMinAndMax,[d,h])}}}return sfx.validation.validator.util.invalidResult(f)}else{if(e&&k.getTime()<e.getTime()){return sfx.validation.validator.util.invalidResult(g.errorMessage?g.errorMessage:sfx.util.getText(sfx.lang.messages.dateRangeOnOrAfterMinDate,[d]))}else{if(a&&k.getTime()>a.getTime()){return sfx.validation.validator.util.invalidResult(g.errorMessage?g.errorMessage:sfx.util.getText(sfx.lang.messages.dateRangeOnOrBeforeMaxDate,[h]))}else{return sfx.validation.validator.util.validResult()}}}},validateChar:function(a,b){return sfx.validation.validator.util.validResult()}});$(document).on("focus.sfx.validation","input:visible, select:visible, textarea",function(b){var a=$("[data-name='"+$(b.currentTarget).attr("name")+"']");a.removeAttr("role")});$(document).on("change.sfx.validation","input:visible, select:visible, textarea",function(a){a.validateRequiredFields=false;sfx.validation.validator.validateInput($(a.target),a)});$(document).on("sfx-form-processing.sfx.validation","form",function(c){if(!c.isDefaultPrevented()){$form=$(c.target);var a=jQuery.Event("sfx-form-validation");a.validateRequiredFields=true;a.originalEvent=c;$form.trigger(a);if(!a.isDefaultPrevented()){var b=sfx.validation.validator.validateForm($form,a);sfx.validation.validator.util.showHideGlobalClient();if(!b){c.originalEvent.preventDefault()}return b}}});(function(){var b=false;var c=function(d){b=false;var f=$(this);if(f.val()!=d.data.val){sfx.validation.validator.util.addRemoveErrorClasses(f,true)}};var a=function(d){var f=$(this);if(f.val()==d.data.val){sfx.validation.validator.util.addRemoveErrorClasses(f,false);$("[data-name='"+sfx.util.escapeSpecialChar(f.attr("name"))+"'].flag").removeClass("hide").addClass("error")}};$(document).on("sfx-init.sfx.alerts","",function(d){$(".flag").not(".hide").each(function(){var e=$(this);var f=$("[name='"+sfx.util.escapeSpecialChar(e.attr("data-name"))+"']");sfx.validation.validator.util.addAriaDescribedBy(f,e);sfx.validation.validator.util.showHideGlobalClient()})});$(document).on("keydown",":text.error, textarea.error, input[type='tel'].error, input[type='email'].error",function(d){if(b===false){b=true;var e=$(d.target);e.one("keyup",{val:e.val()},c);e.one("blur",{val:e.val()},a)}})}());sfx.timeout=new function(){var w="sfxSessionExpiringModal";var g="sfxSessionExpiredModal";var b=["W0102793_PD_H_SESSIONID","W0102793_PD_H_SESSIONID_3"];var e=0;var f=0;var n=0;var m=0;var v=0;$(document).on("sfx-init.sfx.timeout","",function(){p()});var a=function(){clearInterval(n);clearTimeout(m);clearInterval(v);e=f=n=m=v=undefined};var p=function(){a();h();y();$(document).bind("click.sfx.timeout keyup.sfx.timeout",function(z){if($("#"+w).is(":hidden")&&$("#"+g).is(":hidden")){k()}})};var h=function(){e={};e.stayConnectedUrl=$("div#"+w).attr("data-stayConnectedUrl");e.logoutUrl=$("div#"+w).attr("data-logoutUrl");e.displayCounter=$("div#"+w).attr("data-displayCounter");e.warningAfter=$("div#"+w).attr("data-warningTime");e.redirectAfter=$("div#"+w).attr("data-redirectTime")};var y=function(){k();u()};var k=function(){f=Math.floor(new Date().getTime()/1000);r();m=setTimeout(function(){i()},e.warningAfter*1000*60)};var u=function(){clearInterval(v);v=setInterval(function(){j()},e.warningAfter*1000*60)};var r=function(){$("#sfxCounter").html(null);clearInterval(n);clearTimeout(m)};var j=function(){var z=Math.floor(new Date().getTime()/1000);if((z-f)<=(e.warningAfter*60)){s()}else{clearInterval(v)}};var s=function(){$log("",sfx.logger.WARNING)};var i=function(){$("#"+w).modal({backdrop:"static",keyboard:false});l();$("#"+w).focus()};var l=function(){var z=e.redirectAfter*60+f;n=setInterval(function(){if(e.displayCounter){var A=z-Math.floor(Date.now()/1000);$("#sfxCounter").html(sfx.util.getText(sfx.lang.messages.sessionTimeoutModalCountdown,[Math.floor(A/60),Math.floor(A%60)]))}if(Math.ceil(Date.now()/1000)>z){q()}},1000)};var d=function(){r();clearInterval(v);t();$.publish("sfx-session-logout");$("#"+w).modal("hide");$("#content > :not('#sfxSessionExpiredModal')").remove();$("#left-channel").remove()};var q=function(){if(c()){$("#"+g).modal({backdrop:"static",keyboard:false});$("#"+g).focus();if(!sfx.util.isEmpty(e.logoutUrl)){jQuery.ajax({url:sfx.util.appendQueryParam(e.logoutUrl,"cause","expire"),beforeSend:function(B,z){var A=jQuery.Event("sfx-timeout-before");$("#"+g).trigger(A,[z]);return !A.isDefaultPrevented()},error:function(C,z,B){var A="Session Timeout Automated Expiration: Error Status: "+C.status+" Error text: "+C.statusText;$log(A,sfx.logger.ERROR);$("#"+g).trigger("sfx-timeout-error",[C,z,B])}})}}else{$(document).triggerHandler("click")}};var t=function(){if(!sfx.util.isEmpty(b)){for(var z=0;z<b.length;z++){o(b[z],"",-1)}}};var o=function(z,C,A){var D=new Date();D.setDate(D.getDate()+A);var B=escape(C)+(A?"":"; expires="+D.toUTCString());document.cookie=z+"="+B};$("#"+w+" .sfxSessionStayConnected").on("click keydown","",function(z){if(z.type==="click"||z.keyCode===13){var z=jQuery.Event("sfx-session-stayConnected");$(document).trigger(z);if(!z.isDefaultPrevented()){x();if(e.stayConnectedUrl!=undefined){window.location.replace(e.stayConnectedUrl)}}}});var x=function(){$("#"+w).modal("hide");s();$.publish("sfx-session-stayConnected");y()};$("#"+w+" .sfxSessionLogout").on("click keydown","",function(z){if((z.type==="click"||z.keyCode===13)){if(c()){if(e.logoutUrl!=undefined){window.location.replace(sfx.util.appendQueryParam(e.logoutUrl,"cause","user"))}}else{}}});var c=function(){var z=jQuery.Event("sfx-session-logout");$(document).trigger(z);if(!z.isDefaultPrevented()){d();return true}x();$(document).triggerHandler("click");return false};this.redirect=function(z){window.location.replace(z)};$(window).on("pageshow",function(z){if(f>0&&!sfx.util.isEmpty(e.warningAfter)){if(f+e.warningAfter*60<Math.floor(new Date().getTime()/1000)){i()}}})};sfx.waitModal={waitTime:2000,init:function(){$("#sfxWaitModal").modal({keyboard:false,backdrop:"static",show:false})},launch:function(){var a=$("#sfxWaitModal");if(a.length>0){$body=$("body");a.modal("show");$body.addClass("delay-wait-modal");setTimeout(function(){$body.removeClass("delay-wait-modal");waitDialogEvent=jQuery.Event("sfx-waitModal-shown");waitDialogEvent.originalEvent=event;$form.trigger(waitDialogEvent)},sfx.waitModal.waitTime);a.focus()}}};$(document).on("sfx-load.sfx.waitModal","",function(a){sfx.waitModal.init()});$(document).on("sfx-form-processing.sfx.waitModal","form",function(a){if(!a.isDefaultPrevented()){$form=$(a.target);var b=jQuery.Event("sfx-waitModal");b.originalEvent=a;$form.trigger(b);if(!b.isDefaultPrevented()){sfx.waitModal.launch()}}});sfx.toggle={collapseTogglesInSmartphone:function(b,a){if(b=="mobile"){a.find(".open:not(.tab .open)").removeClass("open");a.find("*[data-toggle-group]").addClass("hidden")}},toggleOpenClose:function(c){if(!c.hasClass("disabled")){var e=c.closest(".toggle-container");var d=c.children("a");var a=$('[data-toggle-group="'+c.attr("data-toggle-handler")+'"]');var f=c.parent().hasClass("open");e.toggleClass("open");a.toggleClass("hidden");if(sfx.util.checkHighContrastMode){if(f){$(c).find(".toggle-expand").show();$(c).find(".toggle-collapse").hide()}else{$(c).find(".toggle-expand").hide();$(c).find(".toggle-collapse").show()}}var b=a.hasClass("hidden");a.attr("aria-hidden",b);d.attr("aria-expanded",!b);if(!b){a.focus()}sfx.toggle.toggleTitle(e,d)}},toggleTitle:function(b,a){var c=b.attr("data-openTitle");var d=b.attr("data-title");if(b.hasClass("open")&&c){d=c}a.text(d);a.attr("title",d)},triggerToggledEvent:function(b,a){var c=jQuery.Event("sfx-toggle-toggled");c.originalEvent=a;b.trigger(c)}};$(document).on("sfx-init.sfx","",function(a){sfx.toggle.collapseTogglesInSmartphone(sfx.currentMode,$(a.target));if(sfx.util.checkHighContrastMode){$(".toggle-title").each(function(){var b=$(this).parent().hasClass("open");if(b){$(this).find(".toggle-expand").hide()}else{$(this).find(".toggle-collapse").hide()}})}});$(document).on("click.sfx.collapse-toggle","[data-toggle-handler]",function(b){b.preventDefault();var a=$(b.currentTarget);sfx.toggle.toggleOpenClose(a);sfx.toggle.triggerToggledEvent(a,b)});(function(d){function c(f){if(Object.prototype.toString.call(f)!=="[object Date]"){return false}return !isNaN(f.getTime())}var e={calId:0,startDate:-1,endDate:-1,selectedDate:-1,showPrevNext:true,allowPastDates:true,forceDateUpdate:false};var b;var a={init:function(f){return this.each(function(){var g=d(this);var h=d.extend({},e);h.calId=sfx.util.escapeSpecialChar(g[0].id,"_esc_")+"-date-selector-wrapper";if(f){h=d.extend(h,f)}g.data("settings",h);g.bind("show-selector",a.show);g.bind("hide-selector",a.hide);g.next(".btn-date-selector").click(function(i){if(g.attr("disabled")||g.attr("readonly")){return false}i.stopPropagation();i.preventDefault();if(d(this).siblings(".date-selector-wrapper").length==0||d(this).siblings(".date-selector-wrapper").css("display")=="none"){setTimeout(function(){g.trigger("show-selector")},50)}else{setTimeout(function(){g.trigger("hide-selector")},50)}});d(this).get(0).handler=this})},show:function(h){h.stopPropagation();var i=d(this).val();var f=sfx.util.date.parseDate(i);if(f.isValid){if(f.mm&&f.dd&&f.yyyy){i=f.mm+"/"+f.dd+"/"+f.yyyy}d(this).data("settings").selectedDate=i;d(this).data("settings").overrideDateSelection=false}else{d(this).data("settings").overrideDateSelection=true}d(this).data("settings").forceDateUpdate=true;a.hide.apply(d("._date-selector-container").not(d(this)));a.update.apply(d(this));d(this).siblings(".btn-date-selector").addClass("active");var g=d(this).data("settings");if(d(".btn-date-selector").hasClass("active")){b=true}if(d(this).hasClass("date-selector-top")){if(b!=false){if(d("html").hasClass("lt-ie8")){d("#"+g.calId).css("margin-top",-(d("#"+g.calId).height())-11);if(d(this).hasClass("date-selector-right")){d("#"+g.calId).css("margin-left",d(this).width()-336)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+g.calId).css("margin-left","-112px").find(".triangle").css("left",d(this).width()+32)}}else{d("#"+g.calId).css("margin-top",-(d("#"+g.calId).height())-39);if(d(this).hasClass("date-selector-right")){d("#"+g.calId).css("margin-left",d(this).width()-223)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+g.calId).css("margin-left",0).find(".triangle").css("left",d(this).width()+32)}}}}if(d(this).hasClass("date-selector-bottom")){if(b!=false){if(d("html").hasClass("lt-ie8")){d("#"+g.calId).css("margin-top","40px");if(d(this).hasClass("date-selector-right")){d("#"+g.calId).css("margin-left",d(this).width()-336)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+g.calId).css("margin-left","-112px").find(".triangle").css("left",d(this).width()+28)}}else{d("#"+g.calId).css("margin-top","12px");if(d(this).hasClass("date-selector-right")){d("#"+g.calId).css("margin-left",d(this).width()-227)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+g.calId).css("margin-left",0).find(".triangle").css("left",d(this).width()+28)}}}}},hide:function(){if(d(this).length){var f=d(this).data("settings");d("#"+f.calId).hide();d(this).removeClass("_date-selector-container");d(this).siblings(".btn-date-selector").removeClass("active")}},setStartDate:function(f){d(this).data("settings").startDate=f},setEndDate:function(f){d(this).data("settings").endDate=f},setSelectedDate:function(f){d(this).data("settings").selectedDate=f},update:function(){var f=d(this);var aa=f.data("settings");if(d(".btn-date-selector").hasClass("active")){b=true}var B=aa.calId;var u=aa.startDate;if(aa.startDate==-1){u=new Date();u.setDate(1)}u.setHours(0,0,0,0);var o=u.getTime();var F=new Date(0);if(aa.endDate!=-1){F=new Date(aa.endDate);if((/^\d+$/).test(aa.endDate)){F=new Date(u);F.setDate(F.getDate()+aa.endDate)}}F.setHours(0,0,0,0);var D=F.getTime();var m=new Date(0);if(aa.selectedDate!=-1){m=new Date(aa.selectedDate);if((/^\d+$/).test(aa.selectedDate)){m=new Date(u);m.setDate(m.getDate()+aa.selectedDate)}}m.setHours(0,0,0,0);var h=m.getTime();var l=f.data("theDate");l=(l==-1||typeof l=="undefined")?u:l;if(c(m)&&aa.forceDateUpdate){l=m;aa.forceDateUpdate=false}var C=new Date(l);C.setDate(1);var r=new Date(C);var k=new Date(C);k.setMonth(k.getMonth()+1);k.setDate(0);var ab=new Date(k);r.setYear(r.getFullYear()-1);r.setMonth(r.getMonth()+1);ab.setYear(ab.getFullYear()+1);ab.setMonth(ab.getMonth()-1);var v=C.getTime();var af=k.getTime();var M=k.getDate();var R=r.getTime();var K=ab.getTime();var T=new Date(C);T.setDate(0);T=T.getDate();var t=["January","February","March","April","May","June","July","August","September","October","November","December"];f.data("theDate",l);var q="";for(var N=0,Y=0;N<6;N++){var A="";for(var O=0;O<7;O++,Y++){var V=((T-C.getDay())+Y+1);var W=V-T;var ad=(O==0)?"sun":((O==6)?"sat":"day");if(W>=1&&W<=M){var z=new Date();z.setHours(0,0,0,0);var Z=new Date(l);Z.setHours(0,0,0,0);Z.setDate(W);var ae=Z.getTime();ad=(z.getTime()==ae)?"today":ad;if(!aa.allowPastDates){ad=(ae<o)?"noday":ad}if(aa.endDate!=-1){ad=(ae>D)?"noday":ad}if(aa.selectedDate!=-1){if(!aa.overrideDateSelection){ad=(ae==h)?"selected":ad}else{aa.overrideDateSelection=false}}}else{ad="noday nextmonth";W=(W<=0)?V:((V-M)-T)}if(O==0){A+='<td class="date-selector-container-days first '+ad+" date-selector-container-"+ad+'">'}else{if(O==6){A+='<td class="date-selector-container-days last '+ad+" date-selector-container-"+ad+'">'}else{A+='<td class="date-selector-container-days '+ad+" date-selector-container-"+ad+'">'}}if(ad=="noday nextmonth"){A+='<div class="'+ad+'"  tabindex="-1" style="outline: none"></div></td>'}else{if(ad=="noday"){A+='<div class="'+ad+'"  tabindex="-1">'+W+"</div></td>"}else{A+='<div class="'+ad+'"  tabindex="0" aria-label=\''+t[l.getMonth()]+" "+W+"' >"+W+"</div></td>"}}}q+='<tr class="days"><td class="left-col"></td>'+A+'<td class="right-col"></td></tr>'}var Q=((o<v)||aa.allowPastDates);var E=((af<D)||(D<o));var L=((o<R)||aa.allowPastDates);var w=((K<D)||(D<=o));if(!aa.showPrevNext){showP=showN=false}var g=t[l.getMonth()]+" "+l.getFullYear();var H="date-selector-container-top";if(d(this).hasClass("date-selector-bottom")){H="date-selector-container-bottom"}var I='<div class="date-selector-container '+H+'"><table border="0" role="grid"><tr class="prevnext">'+('<td aria-label="Previous Year" '+(L?'tabindex="0" class="date-selector-container-prevnext prev-y" ':"")+">"+(L?'<span title="'+sfx.lang.messages.DateSelectorPreviousYear+'">'+sfx.lang.messages.DateSelectorPreviousYear+"</span>":"")+"</td>")+('<td aria-label="Previous Month" '+(Q?'tabindex="0" class="date-selector-container-prevnext prev-m" ':"")+">"+(Q?'<span title="'+sfx.lang.messages.DateSelectorPreviousMonth+'">'+sfx.lang.messages.DateSelectorPreviousMonth+"</span>":"")+"</td>")+'<td tabindex=\'0\' class="date-selector-container-monyear" colspan="5" aria-label="current calendar '+g+'">{MY}</td>'+('<td aria-label="Next Month" '+(E?'tabindex="0" class="date-selector-container-prevnext next-m" ':"")+">"+(E?'<span title="'+sfx.lang.messages.DateSelectorNextMonth+'">'+sfx.lang.messages.DateSelectorNextMonth+"</span>":"")+"</td>")+('<td aria-label="Next Year" '+(w?'tabindex="0" class="date-selector-container-prevnext next-y" ':"")+">"+(w?'<span title="'+sfx.lang.messages.DateSelectorNexYear+'">'+sfx.lang.messages.DateSelectorNexYear+"</span>":"")+"</td>")+'</tr><tr class="date-selector-container-dow"><td class="left-col"></td><td aria-label="Sunday">S</td><td aria-label="Monday">M</td><td aria-label="Tuesday">T</td><td aria-label="Wednesday">W</td><td aria-label="Thursday">T</td><td aria-label="Friday">F</td><td aria-label="Saturday">S</td><td class="right-col"></td></td></tr>'+q+'<tr class="close-btn"><td colspan="6"></td><td tabindex=\'0\' aria-label="Close Calendar Button" class="closeBtn" colspan="3"><a tabindex=\'-1\' role=\'button\' class="close" href="#">'+sfx.lang.messages.DateSelectorClose+'</a></td></tr></table><div class="triangle"></div></div>';I=I.replace(/\{MY\}/gi,g);if(d("#"+B).length==0){var ac="absolute";if(b==false){ac="static"}f.after(d("<div aria id='"+B+'\' class="date-selector-wrapper"  tabindex="0"></div>').css({position:ac,"z-index":9999}));if(d("html").hasClass("lt-ie8")){var ac="relative";if(b==false){ac="static"}d(".date-selector-wrapper").parent(".span4").css("position",ac)}}var U=d("#"+B);U.html(I).show();U.find("a.close").bind("click",function(i){d(this).parent().parent().parent().parent().parent().parent().siblings("input.date-selector").focus();d(this).parent().parent().parent().parent().parent().parent().siblings("input.date-selector").trigger("hide-selector");i.preventDefault()});U.find(".closeBtn").keypress(function(i){if(i.which==13){d(this).parent().parent().parent().parent().parent().siblings("input.date-selector").focus();d(this).parent().parent().parent().parent().parent().siblings("input.date-selector").trigger("hide-selector");i.preventDefault()}});U.keyup(function(i){if((i.which==27)){U.siblings("input.date-selector").trigger("hide-selector")}});U.parents().bind("click",function(n){var i=d(n.target);if(!i.is(U)&&!i.closest(U).length){U.siblings("input.date-selector").trigger("hide-selector")}});d(document).on("focus",".modal",function(i){U.siblings("input.date-selector").trigger("hide-selector")});f.addClass("_date-selector-container");function X(){if(d(this).html()!=""){var i=new Date(C);i.setYear(C.getFullYear()-1);f.data("theDate",i);a.update.apply(f);var n=d(".date-selector-wrapper .date-selector-container:visible .date-selector-container-monyear");n.attr("tabindex","0");d(".prev-y").attr("aria-label",i.getFullYear());d(".prev-y").trigger("focus");d(".noday").attr("tabindex","-1")}}function J(){if(d(this).html()!=""){var i=new Date(C);i.setMonth(l.getMonth()-1);f.data("theDate",i);a.update.apply(f);var n=d(".date-selector-wrapper .date-selector-container:visible .date-selector-container-monyear");n.attr("tabindex","0");d(".prev-m").attr("aria-label",t[i.getMonth()]);d(".prev-m").trigger("focus");d(".noday").attr("tabindex","-1")}}function P(){if(d(this).html()!=""){var i=new Date(C);i.setMonth(l.getMonth()+1);f.data("theDate",i);a.update.apply(f);var n=d(".date-selector-wrapper .date-selector-container:visible .date-selector-container-monyear");n.attr("tabindex","0");d(".next-m").attr("aria-label",t[i.getMonth()]);d(".next-m").trigger("focus");d(".noday").attr("tabindex","-1")}}function j(){if(d(this).html()!=""){var i=new Date(C);i.setYear(l.getFullYear()+1);f.data("theDate",i);a.update.apply(f);var n=d(".date-selector-wrapper .date-selector-container:visible .date-selector-container-monyear");n.attr("tabindex","0");d(".next-y").attr("aria-label",i.getFullYear());d(".next-y").trigger("focus");d(".noday").attr("tabindex","-1")}}d(".prev-y",U).click(function(i){i.stopPropagation();X()});d(".prev-y",U).keypress(function(i){if(i.which==13){i.stopPropagation();X()}});d(".prev-m",U).click(function(i){i.stopPropagation();J()});d(".prev-m",U).keypress(function(i){if(i.which==13){i.stopPropagation();J()}});d(".next-m",U).click(function(i){i.stopPropagation();P()});d(".next-m",U).keypress(function(i){if(i.which==13){i.stopPropagation();P()}});d(".next-y",U).click(function(i){i.stopPropagation();j()});d(".next-y",U).keypress(function(i){if(i.which==13){i.stopPropagation();j()}});d("tr.days td:not(.noday, .selected)",U).mouseenter(function(n){var i="date-selector-container-"+d(this).children("div").attr("class");d(this).removeClass(i).addClass(i+"-hover")}).mouseleave(function(n){if(!d(this).hasClass("selected")){var i="date-selector-container-"+d(this).children("div").attr("class");d(this).removeClass(i+"-hover").addClass(i)}}).click(function(s){s.stopPropagation();var n=d(this).children("div").html();var p=f.data("settings");var i=new Date(l);i.setDate(n);f.data("theDate",i);f.val((i.getMonth()+1)+"/"+i.getDate()+"/"+i.getFullYear());f.change();if(p.onChange!=null&&typeof p.onChange!="undefined"){p.onChange(f,i)}p.selectedDate=i;a.hide.apply(f);d(this).closest(".date-selector-wrapper").siblings(".date-selector").focus()});var S=aa;if(d(this).hasClass("date-selector-top")){if(b!=false){if(d("html").hasClass("lt-ie8")){d("#"+S.calId).css("margin-top",-(d("#"+S.calId).height())-11);if(d(this).hasClass("date-selector-right")){d("#"+S.calId).css("margin-left",d(this).width()-336)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+S.calId).css("margin-left","-112px").find(".triangle").css("left",d(this).width()+32)}}else{d("#"+S.calId).css("margin-top",-(d("#"+S.calId).height())-39);if(d(this).hasClass("date-selector-right")){d("#"+S.calId).css("margin-left",d(this).width()-223)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+S.calId).css("margin-left",0).find(".triangle").css("left",d(this).width()+32)}}}}if(d(this).hasClass("date-selector-bottom")){if(b!=false){if(d("html").hasClass("lt-ie8")){d("#"+S.calId).css("margin-top","40px");if(d(this).hasClass("date-selector-right")){d("#"+S.calId).css("margin-left",d(this).width()-336)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+S.calId).css("margin-left","-112px").find(".triangle").css("left",d(this).width()+28)}}else{d("#"+S.calId).css("margin-top","12px");if(d(this).hasClass("date-selector-right")){d("#"+S.calId).css("margin-left",d(this).width()-227)}if(d(this).hasClass("date-selector-left")||d(window).width()<599){d("#"+S.calId).css("margin-left",0).find(".triangle").css("left",d(this).width()+28)}}}}d("#"+S.calId).find(".date-selector-container").attr("aria-expanded","true");var G=d("#"+S.calId).find(".date-selector-container .selected div");if(d("#"+S.calId).find(".date-selector-container .selected").length>0){var G=d("#"+S.calId).find(".date-selector-container .selected div")}else{if(d("#"+S.calId).find(".date-selector-container .today").length>0){var G=d("#"+S.calId).find(".date-selector-container .today div")}else{var G=d("#"+S.calId).find(".date-selector-container .day:first .day")}}G.attr("tabindex","0");G.focus()}};d.fn.glDatePicker=function(f){if(a[f]){return a[f].apply(this,Array.prototype.slice.call(arguments,1))}else{if(typeof f==="object"||!f){return a.init.apply(this,arguments)}else{d.error("Method "+f+" does not exist on jQuery.glDatePicker")}}}})(jQuery);$(document).on("sfx-init.sfx.dateselector","",function(c){var a,e,d,b;$(c.target).find(".date-selector").each(function(){var f=$(this);var g='<a aria-hidden="false" role="button"';if(f.attr("disabled")||f.attr("readonly")){g+='class="btn btn-secondary btn-date-selector disabled" aria-disabled="true"'}else{g+='class="btn btn-secondary btn-date-selector" href="#"'}g+='><span class="label">Pick date</span><span class="icon"></span></a>';f.after(g);a=f.attr("data-min");e=f.attr("data-max");if(a!=null){d=sfx.util.date.parseDate(a,true);if(d.isValid){a=d.mm+"/"+d.dd+"/"+d.yyyy}else{a=null}}if(e!=null){b=sfx.util.date.parseDate(e,true);if(b.isValid){e=b.mm+"/"+b.dd+"/"+b.yyyy}else{e=null}}if(a==null&&e==null){f.glDatePicker({allowPastDates:true,selectedDate:new Date()})}if(a!=null&&e!=null){f.glDatePicker({allowPastDates:false,endDate:new Date(e),startDate:new Date(a),selectedDate:new Date("99990101")})}else{if(e!=null){f.glDatePicker({allowPastDates:true,endDate:new Date(e),selectedDate:new Date("19010101")})}else{if(a!=null){f.glDatePicker({allowPastDates:false,startDate:new Date(a),selectedDate:new Date("99990101")})}}}});$("body").keydown(function(g){var f=$(document.activeElement);if(g.which==13&&(f.hasClass("day")||f.hasClass("sun")||f.hasClass("sat")||f.hasClass("today"))){g.preventDefault();$(document.activeElement).trigger("click")}if(g.shiftKey&&g.which==9&&f.hasClass("closeBtn")){g.preventDefault();f=$(document.activeElement).parent().siblings().children().children("[tabindex=0]").last()}if(g.which==9&&f.hasClass("closeBtn")){g.preventDefault();f=$(document.activeElement).parent().siblings(".prevnext").children("[tabindex=0]").first()}if(g.shiftKey&&g.which==9&&f.hasClass("prev-y")){g.preventDefault();f=$(document.activeElement).parent().siblings(".close-btn").children(".closeBtn")}if(g.shiftKey&&g.which==9&&f.hasClass("prev-m")){g.preventDefault();if(f.prev().attr("class")==undefined){f=$(document.activeElement).parent().siblings(".close-btn").children(".closeBtn")}else{f=f.prev()}}if(g.shiftKey&&g.which==9&&f.hasClass("date-selector-container-monyear")){g.preventDefault();if(f.prev().attr("class")==undefined){f=$(document.activeElement).parent().siblings(".close-btn").children(".closeBtn")}else{f=f.prev()}}f.trigger("focus")})});