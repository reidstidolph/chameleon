var angularApp = angular.module('dell', []);
...
angularApp.controller('dellController', ["$scope", "chameleonService", function($scope, chameleonService){
    ...
    $scope.doVoiceCall = function(){
        ...
        chameleonService.makeCall("webrtc8@reidlab.com", audioCall);
    };
    
    $scope.doVideoCall = function(){
        console.log("Make video call button clicked");
        $scope.syncData.form.active = false;
        chameleonService.makeCall("webrtc8@reidlab.com", videoCall);
    };
