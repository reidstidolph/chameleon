var angularApp = angular.module('toyota', []);
...
angularApp.controller('toyotaController', ["$scope", "chameleonService", function($scope, chameleonService){
    ...
    $scope.doVoiceCall = function(){
        ...
        chameleonService.makeCall("webrtc2@reidlab.com", audioCall);
    };
    
    $scope.doVideoCall = function(){
        console.log("Make video call button clicked");
        $scope.syncData.form.active = false;
        chameleonService.makeCall("webrtc2@reidlab.com", videoCall);
    };
