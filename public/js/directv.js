var angularApp = angular.module('directv', []);
...
angularApp.controller('directvController', ["$scope", "chameleonService", function($scope, chameleonService){
    ...
    $scope.doVoiceCall = function(){
        ...
        chameleonService.makeCall("webrtc4@reidlab.com", audioCall);
    };
    
    $scope.doVideoCall = function(){
        console.log("Make video call button clicked");

        chameleonService.makeCall("webrtc4@reidlab.com", videoCall);
    };
